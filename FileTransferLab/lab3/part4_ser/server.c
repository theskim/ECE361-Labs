...
int main(int argc, char *argv[]){
    ...
    do {      
        do {
            ...
            if (random_number % 10 < 2){ // 0, 1,2 30% chance;
            ...
            *(filename + curr_index) = '\0';
            ...
            if (prev_packet_num == packet_num - 1 && prev_packet_num != -1){ // Detect successfully received (incremented packet num)
            ...
            if (prev_packet_num == packet_num - 1)
                sendto(server_socket, "yes", strlen("yes"), 0, (struct sockaddr*) &sin, sizeof(sin));
            else
                sendto(server_socket, "no", strlen("yes"), 0, (struct sockaddr*) &sin, sizeof(sin));
